$(function () {
    ...
    var table = $('#js-reseller').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: BASE_URL + "/showlaporanmarketer?keyword="+ keyword + "&bulan=" + bulan + "&tahun=" + tahun,
        buttons: [
    ...
    $("#btn_cari").on('click', function (e) {
        ...
        setRepot.ajax = BASE_URL + "/showlaporanmarketer?keyword="+ keyword + "&bulan=" + bulan + "&tahun=" + tahun;
        table.fnDraw();
    });
