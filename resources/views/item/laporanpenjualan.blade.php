                    ...
                    <div class="card">
                        <div class="body">
                            <form class="form-horizontal">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-1 col-md-1 col-sm-4 col-xs-5 form-control-label">
                                        <label for="tgl_awal">Kode</label>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="keyword" class="form-control" placeholder="Kode">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@stop
@section('plugin-css')
    <link href="{{mix('plugin/css/laporanpenjualan.css')}}" rel="stylesheet">
@stop

@section('plugin-js')
    <script src="{{mix('plugin/js/laporanpenjualan.js')}}"></script>
@stop

@section('pages-js')
    <script src="{{mix('js/pages/laporanpenjualan.js')}}"></script>
@stop
