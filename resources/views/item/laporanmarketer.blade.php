...
@stop
@section('plugin-css')
    <link href="{{mix('plugin/css/laporanmarketer.css')}}" rel="stylesheet">
@stop

@section('plugin-js')
    <script src="{{mix('plugin/js/laporanmarketer.js')}}"></script>
@stop

@section('pages-js')
    <script src="{{mix('js/pages/laporanmarketer.js')}}"></script>
@stop
